...
Zum Aneignen des Zertifizierungswissens und als Training für die Zeritifizierungsprüfung wurden die Labor-Übungen vom FortiAnalyzer Kurs durchgeführt. Diese wurden in vier Kapitel unterteilt, die an die Kapitel aus dem Online-Kurs angelehnt sind:
...
Im #htl3r.long[soc] spielt auch die Inspizierung des Traffics eine wichtige Rolle. Durch die FortiAnalyzer-Dashboard kann schnell ein Überblick über die Geschehnisse im Netzwerk gewonnen werden. Neben aktiven Sessions kann auch ermittelt werden, welche Geräte am meisten Bandbreite verbrauchen und in welche Länder die Sessions terminieren. Am Beispiel der #htl3r.short[ad] Infrastruktur konsumieren die Windows-Clients und der Jump-Server am meisten Bandbreite. Die Länder mit den größten Datenaufkommen sind Österreich, Großbritannien und die USA.
