...
2. *Man-in-the-Middle* - Der Netzwerkverkehr der Kommunikation zwischen der SPS und den Steuergeräten wird abgefangen und aufgezeichnet. 
...
2. *Fuzzing* - Durch Senden zufälliger Daten an die Eingabeschnittstelle der SPS wird geprüft, ob es zu unerwünschtem Verhalten kommt. 
3. *Replay* - Es wird legitimer Netzwerkverkehr aufgezeichnet und später erneut abgesendet. 
4. *Code Injections* - Unerwünschter Code wird in das SPS-Programm injiziert, um dessen Verhalten zu manipulieren. 
