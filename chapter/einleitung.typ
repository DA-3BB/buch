...
Im folgenden wird die Topologie der Diplomarbeit mit ihren Netzwerken abgebildet. Auf der linken Seite befindet sich das OT-Netzwerk rundum die Modelleisenbahn und auf der rechten Seite die beiden IT-Standorte des simulierten Unternehmens. Diese werden über das Internet miteinander verbunden.
/*
...
Die Topologie der Diplomarbeit 3BB wird grundsätzlich in einen physischen und virtuellen Bereich eingeteilt. Die Geräte der #htl3r.short[ot], die zur Steuerung der Eisenbahn verwendet werden, sind physisch auf der Modelleisenbahn stationiert: dazu gehört eine #htl3r.short[sps], ein Raspberry Pi und #htl3r.fullpl[rtu]. Der Stromfluss der Schienen und die Servomotoren zum Ansteuern der Weichen bilden die Aktoren ab. Dabei nimmt die #htl3r.short[sps] die Steuerbefehle entgegen und leitet sie zu den #htl3r.longpl[rtu] weiter. Mehr dazu in @blocksteuerung und @chapter-weichensteuerung. Das Eisenbahnnetzwerk wird durch eine physische Firewall von Fortinet am Standort isoliert. Dies soll mögliche Angriffsvektoren auf das Netzwerk begrenzen.
...
Die #htl3r.short[it]-Standorte simulieren ein Unternehmensnetzwerk, das mittels #htl3r.full[ad] realisiert wird. Mitarbeiterinnen und Mitarbeiter sollen durch ein #htl3r.full[hmi] Zugriff auf die Steuerelemente der #htl3r.short[sps] haben. Dieser Zugriff ist über die anderen beiden Firewalls abgesichert. Des Weiteren sind diverse Security-Geräte von Fortinet im Einsatz: Ein #htl3r.short[siem] übernimmt die Netzwerküberwachung im gesamten Unternehmen und soll mithilfe von Dashboards einen guten Überblick über den Zustand des Netzwerks bieten. Diese Komponente wird in @fsm erläutert. Durch ein #htl3r.short[soc] und dessen im #htl3r.long[ad] hinterlegten Benutzer soll ein Cyberdefense-Umfeld innerhalb des Unternehmens realisiert werden. Mehr dazu in @faz.
