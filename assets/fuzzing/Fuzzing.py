...
def FuzzWriteCoil(session: Session):
    ...
    s_byte(0x05, name='Function Code for Write Coil', fuzzable=False, endian=BIG_ENDIAN)
    s_word(0x0000, name='Address', fuzzable=True, endian=BIG_ENDIAN)
...
if __name__ == "__main__":
    ...
    target = Target(connection=TCPSocketConnection(host=args.a, port=502))
